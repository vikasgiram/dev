        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
              ...
              <Link
                ...
                className={`nav-link flex items-center space-x-2 px-3 py-2 rounded-lg transition-smooth ${
                  isActivePath(item.path) 
                    ? 'text-text-primary active' :'text-black hover:text-white hover:bg-primary'
                }`}
              >
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <Button
              ...
              iconName="Github"
              iconPosition="left"
              onClick={() => window.open('https://github.com/vikasgiram', '_blank')}
            >
              GitHub
            </Button>
            <Button
            ...
            <nav className="py-4 space-y-2">
              ...
              <div className="pt-4 mt-4 border-t border-border/50 space-y-3">
                <Button
                  ...
                  fullWidth
                  onClick={() => {
                    window.open('https://github.com/vikasgiram', '_blank');
                    closeMobileMenu();
                  }}
                >
                  View GitHub Profile
