...
const CybersecurityFoundation = () => {
  ...
  const foundations = [
    ...
    },
    {
      ...
      degree: "Multiple Security Certifications",
      year: "2020-2023",
      description: "Continuous learning through industry-recognized certifications to stay current with evolving security threats and best practices.",
      skills: ["CEH", "CISSP", "CompTIA Security+", "AWS Security"],
      icon: "Award",
      color: "accent"
    },
    {
