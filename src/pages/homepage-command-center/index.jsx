...
import TechnicalBlogFeed from './components/TechnicalBlogFeed';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-primary-200 text-sm">Security-First Full-Stack Developer</p>
                </div>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-primary-200">
                ...
                <li><a href="#" className="hover:text-accent transition-smooth">Projects</a></li>
                <li><a href="#" className="hover:text-accent transition-smooth">Services</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-primary-200">
                <li><a href="#" className="hover:text-accent transition-smooth">Web Development</a></li>
                <li><a href="#" className="hover:text-accent transition-smooth">API Development</a></li>
                <li><a href="#" className="hover:text-accent transition-smooth">Security Audit</a></li>
                <li><a href="#" className="hover:text-accent transition-smooth">Consultation</a></li>
                <li><a href="#" className="hover:text-accent transition-smooth">Code Review</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-primary-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-primary-200 text-sm">
              © {new Date().getFullYear()} VikasGiram.dev. All rights reserved.
            </p>
